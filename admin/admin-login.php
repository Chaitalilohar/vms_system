...
if(isset($_REQUEST['sign_in'])){
    extract($_POST);
    include 'db.php';
    $q="select * from admin where ad_name='$name' and ad_password='$password'";
    $res=mysqli_query($connect,$q);
    if(mysqli_num_rows($res)>=1){
        header('location:admin.php');
    }
    else{
        echo "<script>alert('Password or username is wrong please try again!!!');
            window.history.back();
        <\script>";
          ...
          <div class="col-md-8 col-lg-4 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                ...
                <p><h2 class="text-center">Admin Login</h2></p>
                <form method="post" action="">
                  ...
                  <button name="sign_in" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Sign In</button>
